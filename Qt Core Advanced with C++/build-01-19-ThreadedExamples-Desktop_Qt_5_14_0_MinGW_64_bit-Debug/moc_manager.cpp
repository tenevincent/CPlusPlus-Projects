...
#include <memory>
#include "../01-19-ThreadedExamples/manager.h"
...
QT_MOC_LITERAL(4, 20, 7), // "process"
QT_MOC_LITERAL(5, 28, 4) // "quit"

    },
    "Manager\0start\0\0stop\0process\0quit"
};
...
void Manager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Manager::start)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Manager::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Manager::stop)) {
                *result = 1;
                return;
            }
        }
