...
QT_MOC_LITERAL(3, 20, 6), // "myslot"
QT_MOC_LITERAL(4, 27, 9), // "firstName"
QT_MOC_LITERAL(5, 37, 8), // "lastName"
QT_MOC_LITERAL(6, 46, 11) // "departement"

    },
    "TestClass\0mysignal\0\0myslot\0firstName\0"
    "lastName\0departement"
};
...
void TestClass::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (TestClass::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TestClass::mysignal)) {
                *result = 0;
                return;
            }
        }
        ...
        case 1: *reinterpret_cast< QString*>(_v) = _t->getLastName(); break;
        case 2: *reinterpret_cast< QString*>(_v) = _t->getDepartement(); break;
        default: break;
        }
        ...
        case 2: _t->setDepartement(*reinterpret_cast< QString*>(_v)); break;
        default: break;
        }
