// typeCategories.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main() {
    ...
    std::cout << "std::is_member_object_pointer<int A::*>::value: " << std::    <int A::*>::value << std::endl;
