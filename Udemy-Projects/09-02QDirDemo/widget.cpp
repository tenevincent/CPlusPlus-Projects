...
void Widget::on_pushButtonChooseDirectory_clicked()
{
...
void Widget::on_pushButtonDirectoryExists_clicked()
{
...
void Widget::on_pushButtonCreateDirectory_clicked()
{
...
void Widget::on_pushButtonDirOrFile_clicked()
{
    ...
    if(nullptr ==  currentItem){
        QMessageBox::information(this,"File Selection","No File selected...");
        return;
    }
...
void Widget::on_pushButtonFolderContents_clicked()
{
    ui->listWidget->clear();
